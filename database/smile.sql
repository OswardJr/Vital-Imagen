...
INSERT INTO `bitacora` (`id_bitacora`, `usuario_id`, `accion`, `descripcion`, `fecha`) VALUES
...
CREATE TABLE `pacientes` (
  ...
  `nac_paciente` varchar(2) COLLATE utf8mb4_spanish_ci NOT NULL,
  ...
  `telefono_local` varchar(20) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `telefono_movil` varchar(20) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `id_estado` int(11) NOT NULL,
  `id_ciudad` int(11) NOT NULL,
...
INSERT INTO `pacientes` (`nro_historia`, `nac_paciente`, `ced_paciente`, `nombres`, `apellidos`, `sexo`, `fecha_nacimiento`, `telefono_local`, `telefono_movil`, `id_estado`, `id_ciudad`, `id_parroquia`, `direccion`, `status`) VALUES
(1, 'V', 24924739, 'LEONCIO ENRIQUE', 'REQUENA GONZALEZ', 'Masculino', '1995-08-14', '', '0424-3109770', 4, 61, 122, 'VISTA HERMOSA PARCELA 12 #17', 'Activo');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `sexo`, `correo`, `usuario`, `password`, `pregunta_secreta`, `respuesta_secreta`, `status`) VALUES
(1, 'Administrador', 'Administrador', 'Masculino', 'admin@gmail.com', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Color Favorito?', 'rojo', 'Activo');
...
ALTER TABLE `pacientes`
  ADD PRIMARY KEY (`nro_historia`) USING BTREE,
...
ALTER TABLE `pacientes`
  ...
  ADD CONSTRAINT `pacientes_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON UPDATE CASCADE;
