...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-02-2018 a las 09:21:11
...
CREATE TABLE `bitacora` (
  ...
  `accion` enum('Insertar','Borrar','Update','Respaldo','Pdf','Sesion') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `citas` (
  ...
  `hora` time NOT NULL,
  `status_atencion` enum('Pendiente','Atendido','Cancelado','') COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `intervencion` (
  ...
  `nombre_intervencion` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `descripcion_intervencion` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cantidad_quirofano` int(50) NOT NULL,
  `importe_quirofano` double(10,2) NOT NULL,
  `cantidad_oxigeno` int(50) NOT NULL,
  `importe_oxigeno` double(10,2) NOT NULL,
  `cantidad_reten` int(50) NOT NULL,
  `importe_reten` double(10,2) NOT NULL,
  `cantidad_hospitalizacion` int(50) NOT NULL,
  `importe_hospitalizacion` double(10,2) NOT NULL,
  `cantidad_medico` int(50) NOT NULL,
  `importe_medico` double(10,2) NOT NULL,
  `cantidad_enfermera` int(50) NOT NULL,
  `importe_enfermera` double(10,2) NOT NULL,
  `cantidad_alimentacion` int(50) NOT NULL,
  `importe_alimentacion` double(10,2) NOT NULL,
  `precio_total` double(10,2) NOT NULL,
  `status_intervencion` enum('Activo','Inactivo','','') COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `inventario` (
  `proovedores_id` int(11) NOT NULL,
  `lotes_id` int(11) NOT NULL,
  `productos_id` int(11) NOT NULL,
  `fechaEnt` date NOT NULL,
  `fechaVenc` date NOT NULL,
  `cantidad` int(11) NOT NULL,
  `status_inventario` enum('Activo','Inactivo','Pendiente','') COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `lotes` (
  ...
  `codigo_lote` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `productos_lote` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pagos` (
  ...
  `ced_paciente` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
  `total_cancelar` double(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `presupuestos` (
  ...
  `tipo_intervencion` int(11) NOT NULL,
  `d_vencimiento` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `status` enum('Activo','Inactivo','','') COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
--
-- Estructura de tabla para la tabla `presupuesto_intervencion`
--

CREATE TABLE `presupuesto_intervencion` (
  `id_intervencion` int(11) DEFAULT NULL,
  `id_doctor` int(11) DEFAULT NULL,
  `precio_doctor` double(10,2) DEFAULT NULL,
...
CREATE TABLE `productos` (
  ...
  `precio_entrada` double(10,3) NOT NULL,
...
CREATE TABLE `proveedores` (
  ...
  `rif_proveedor` varchar(40) COLLATE utf8mb4_spanish_ci NOT NULL,
  `contacto_proveedor` varchar(60) COLLATE utf8mb4_spanish_ci NOT NULL,
  `telefono_proveedor` varchar(11) COLLATE utf8mb4_spanish_ci NOT NULL,
  `localidad_proveedor` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `temp_productos`
--
...
--
-- Estructura de tabla para la tabla `temp_profesionales`
--

CREATE TABLE `temp_profesionales` (
  `id_doctor` int(11) NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `sexo` enum('Masculino','Femenino','Indefinido') COLLATE utf8mb4_unicode_ci NOT NULL,
  `correo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `usuario` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pregunta_secreta` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `respuesta_secreta` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `sexo`, `correo`, `usuario`, `password`, `pregunta_secreta`, `respuesta_secreta`, `status`, `id_tipo`) VALUES
(1, 'Leobaldo', 'Sarmiento', 'Masculino', 'admin@gmail.com', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Color Favorito?', 'rojo', 'activo', 1);
...
ALTER TABLE `inventario`
  ADD KEY `proovedores_id` (`proovedores_id`),
  ADD KEY `lotes_id` (`lotes_id`),
...
ALTER TABLE `pacientes`
  ...
  ADD KEY `nro_historia` (`nro_historia`),
...
ALTER TABLE `presupuestos`
  ...
  ADD KEY `ced_paciente` (`ced_paciente`),
  ADD KEY `tipo_intervencion` (`tipo_intervencion`);

--
-- Indices de la tabla `presupuesto_intervencion`
--
ALTER TABLE `presupuesto_intervencion`
  ADD KEY `id_doctor` (`id_doctor`),
...
--
-- Indices de la tabla `temp_productos`
--
ALTER TABLE `temp_productos`
  ADD KEY `id_producto` (`id_producto`);

--
-- Indices de la tabla `temp_profesionales`
--
ALTER TABLE `temp_profesionales`
  ADD KEY `id_doctor` (`id_doctor`);
...
--
ALTER TABLE `intervencion`
  MODIFY `id_intervencion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pacientes`
  MODIFY `nro_historia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `presupuestos`
  MODIFY `nro_presupuesto` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `bitacora`
  ADD CONSTRAINT `bitacora_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE;

--
-- Filtros para la tabla `citas`
--
ALTER TABLE `citas`
  ADD CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`id_doctor`) REFERENCES `doctores` (`id_doctor`) ON UPDATE CASCADE,
  ADD CONSTRAINT `citas_ibfk_2` FOREIGN KEY (`ced_paciente`) REFERENCES `pacientes` (`ced_paciente`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `consultas`
  ADD CONSTRAINT `consultas_ibfk_1` FOREIGN KEY (`ced_paciente`) REFERENCES `pacientes` (`ced_paciente`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `pacientes`
  ADD CONSTRAINT `pacientes_ibfk_1` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON UPDATE CASCADE,
  ADD CONSTRAINT `pacientes_ibfk_2` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `pagos`
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `pago_paciente_ibfk_2` FOREIGN KEY (`ced_paciente`) REFERENCES `pacientes` (`ced_paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pago_usuario_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `presupuestos`
  ADD CONSTRAINT `intervencion_ibfk_2` FOREIGN KEY (`tipo_intervencion`) REFERENCES `intervencion` (`id_intervencion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `presupuestos_ibfk_1` FOREIGN KEY (`ced_paciente`) REFERENCES `pacientes` (`ced_paciente`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `presupuesto_intervencion`
--
ALTER TABLE `presupuesto_intervencion`
  ADD CONSTRAINT `detalle_doctor_ibfk_1` FOREIGN KEY (`id_doctor`) REFERENCES `doctores` (`id_doctor`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalle_intervencion_ibfk_1` FOREIGN KEY (`id_intervencion`) REFERENCES `intervencion` (`id_intervencion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalle_producto_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `productos`
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_2` FOREIGN KEY (`categorias_id`) REFERENCES `categorias` (`id_categoria`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_usuario` (`id_tipo`) ON DELETE CASCADE;
COMMIT;
