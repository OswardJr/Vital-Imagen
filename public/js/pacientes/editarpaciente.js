$(document).ready(function(){
	$('#guardar').click(function(e){
		e.preventDefault();
	var cedula,nombre,apellido,sexo,fecha_nacimiento,telefono,estado,ciudad,municipio,parroquia,direccion,responsable,expcedula,expnombre,expapellido,expfecha,exptelefono,expdireccion;
