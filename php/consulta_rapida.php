    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-4">
               ...
               <input type="text" id="nro_historia" name="nro_historia" class="form-control" readonly value="">
            </div>

            <div class="form-group col-md-4">
               <label for="">Nombre <span style="color: red;">*</span></label> 
               <input type="text" name="nombre" id="nombre" class="form-control" readonly value="">
            </div>
