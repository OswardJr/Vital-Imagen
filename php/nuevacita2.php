...
$cedula=$_GET['ced'];
$pc=$con->query("SELECT * FROM pacientes WHERE ced_paciente='$cedula' AND status='Activo'");
$c=mysqli_fetch_assoc($pc);
                    ...
                    <div class="panel-body">
                        <form action="" id="form_cita">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ejemp:Leoncio Enrique" disabled value="<?php echo $c['nombres']; ?>">
                            </div>     
                                 <div class="form-group col-md-4">
                                <label for="password">Apellidos <span style="color: red;">*</span> </label>
                                <input type="text" name="apellido" id="apellido" class="form-control" placeholder="Requena Gonzalez" disabled value="<?php echo $c['apellidos']; ?>">
                            </div>     
                             </div>    
                            ...
                            <div class="form-group col-md-6">
                             ...
                             <div class="form-group col-md-6">
                              ...
                              <div class="botones-formulario text-center">                           
                                ...
                                <a href="inicio.php" class="btn btn-lca">
